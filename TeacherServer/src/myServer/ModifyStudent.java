...
public class ModifyStudent extends javax.swing.JFrame {
    ...
    public ModifyStudent() {
     ...
     public ModifyStudent(Connection db) {
        initComponents();
    ...
    private void initComponents() {
        ...
        newPassword.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        try 
        {
            ...
            if(res==0)
            {
                JOptionPane.showMessageDialog(this,"Sorry, the update did not take place. Try again!");
                clearButtonActionPerformed(evt);
            }
            else
            {
