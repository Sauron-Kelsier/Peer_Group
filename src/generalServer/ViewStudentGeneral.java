 ...
 * @author sukalyan14
 */
public class ViewStudentGeneral extends javax.swing.JFrame {
    ...
    public ViewStudentGeneral() {
        initComponents();
    }
    
    public ViewStudentGeneral(Connection db) {
        initComponents();
    ...
    private void initComponents() {
        ...
        heading.setText(Util.messages.getString("viewStudentDetails"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewStudentGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ViewStudentGeneral().setVisible(true);
            }
        });
    }
